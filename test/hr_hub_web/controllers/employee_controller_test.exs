defmodule HrHubWeb.EmployeeControllerTest do
  use HrHubWeb.ConnCase

  alias HrHub.HrHub

  @create_attrs %{annual_salary: 42, first_name: "some first_name", last_name: "some last_name", payment_start_date: ~D[2010-04-17], pension_contribution: 42}
  ...
  def fixture(:employee) do
    {:ok, employee} = HrHub.create_employee(@create_attrs)
    employee
  end
